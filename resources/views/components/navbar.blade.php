    <nav class="fixed top-0 left-0 p-4 w-full px-4 py-4 flex justify-between items-center bg-white border-b-2 z-50">
        ...
        <ul
            ...
            <li><x-navlink href="/about" :active="request()->is('about')">About Us</x-navlink></li>
            <li class="text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                    class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li><x-navlink href="/product" :active="request()->is('product') ">Products</x-navlink></li>
            <li class="text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                    class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li><x-navlink href="/gallery" :active="request()->is('gallery')">References</x-navlink></li>
            <li class="text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                    class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
