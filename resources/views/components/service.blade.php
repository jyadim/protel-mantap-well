<section id="features" class="container mx-auto px-4 space-y-6  py-8 md:py-12 lg:py-20 mt-10">
    ...
    <div class="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
        ...
        <div
            class="relative overflow-hidden rounded-lg border bg-white select-none hover:shadow hover:shadow-lime-200 p-2">
