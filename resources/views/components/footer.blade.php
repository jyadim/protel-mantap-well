    ...
    <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
            ...
            <div class="flex items-center mt-1 space-x-3">
                <a href="https://www.youtube.com/channel/UCG0eHGu5ZY9LVS7qo9kqyTw"
                    class="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400">
                    <svg width="29px" height="29px" viewBox="0 -7 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <a href="https://www.facebook.com/komarudin.bagar?mibextid=ZbWKwL"
                    class="text-blue-500 transition-colors duration-300 hover:text-deep-purple-accent-400">
