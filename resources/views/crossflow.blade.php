    ...
    <section class="w-full mx-auto py-10 bg-gray-50 dark:bg-white dark:text-white">
        <div
            ...
            <div class="lg:w-[50%] xs:w-full">
                <img class="lg:rounded-t-lg sm:rounded-sm xs:rounded-sm h-full object-cover"
            ...
            <div
                class="lg:w-[50%] sm:w-full xs:w-full bg-gray-100 dark:bg-white dark:text-gray-400 md:p-4 xs:p-0 rounded-md">
                <h5 class="text-3xl font-semibold text-gray-900 dark:text-black">What is an electronic load controller?
                </h5>
                <p class="text-md mt-4 dark:text-black">Electronic Load Controller (ELC) is a controller used in micro
                    hydro power to control load and frequency of generator by diverting excess power generated to
                    dummy/ballast load.
                    The purpose of ELC is to make sure that generated power is the same with consumed power (main
                    load+ballast load)
                    Power diversion to ballast load is done by electronic switch Thyristor and automatically without any
                    moving parts.
                    Therefore frequency and voltage will be maintained and stable. Following are some brief advantages
                    of ELC for micro hydro power :<br>
        ...
        <!-- col-2 -->
        <div
            class="xl:w-[80%] sm:w-[85%] xs:w-[90%] mx-auto flex md:flex-row xs:flex-col lg:gap-4 xs:gap-2 justify-center lg:items-stretch md:items-center mt-6">
            <!-- Kotak teks -->
            <div
                class="lg:w-[50%] xs:w-full bg-gray-100 dark:bg-white dark:text-gray-400 md:p-4 xs:p-4 rounded-md flex flex-col">
            ...
            <div class="lg:w-[50%] xs:w-full flex-shrink-0">
                <img class="lg:rounded-t-lg sm:rounded-sm xs:rounded-sm w-full h-full object-cover"
        ...
        <div
            ...
            <div
                class="lg:w-[50%] xs:w-full bg-gray-100 dark:bg-white dark:text-gray-400 md:p-4 xs:p-4 rounded-md flex flex-col">
                <h3 class="text-3xl font-semibold text-gray-900 dark:text-black mb-2">Standard Protection And Standard
                    Metering</h3>
                <p class="text-md dark:text-black">
