                    ...
                    <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                        ...
                        <div class="relative mb-4">
                            ...
                            <textarea id="Address" name="Address"
                                class="w-full bg-white rounded border border-gray-300 focus:border-red-500 focus:ring-2 focus:ring-red-200 h-16 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
                        </div>
                        <div class="relative mb-4">
                        ...
                        <div class="relative mb-4">
                            <label for="numrand" class="leading-7 text-sm text-gray-600">Enter This Following Numbers : </label><br>
                            <label for="rand" class="font-bold"><?= rand(100000, 200000)?></label>
                            <input type="number" id="numrand" name="numrand"
                                class="w-full bg-white rounded border border-gray-300 focus:border-red-500 focus:ring-2 focus:ring-red-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        </div>
                        <button
                            class="text-white bg-lime-600 border-0 py-2 px-6 focus:outline-none hover:bg-lime-700 rounded text-lg">Button</button>
                    </div>
                </div>
            </section>
        </main>
