                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="#"
                                    ...
                                    Us</a>
                                <a href="/p"
                                    class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-lime-600 hover:text-white">Contact
                                    Us</a>
                            </div>
                        </div>
                    </div>
        ...
        <main>
            ...
            <div class="container mx-auto p-4 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-4">
                <div class="relative rounded overflow-hidden shadow-lg">
                    <img src="https://tailwindui.com/img/ecommerce-images/product-page-01-related-product-01.jpg" alt="About Us" class="w-full h-64 object-cover">
                    <div class="absolute bottom-0 left-0 bg-black bg-opacity-50 text-white p-4 w-full">
                        <h3 class="text-xl font-bold">About Us</h3>
                        <a href="#" class="text-sm ">detail</a>
                    </div>
                </div>
                <div class="relative rounded overflow-hidden shadow-lg">
                    <img src="https://tailwindui.com/img/ecommerce-images/product-page-01-related-product-01.jpg" alt="Gallery" class="w-full h-64 object-cover">
                    <div class="absolute bottom-0 left-0 bg-black bg-opacity-50 text-white p-4 w-full">
                ...
                <div class="relative rounded overflow-hidden shadow-lg">
                    <img src="https://tailwindui.com/img/ecommerce-images/product-page-01-related-product-01.jpg" alt="Products" class="w-full h-64 object-cover">
                    <div class="absolute bottom-0 left-0 bg-black bg-opacity-50 text-white p-4 w-full">
                ...
                <div class="relative rounded overflow-hidden shadow-lg">
                    <img src="https://tailwindui.com/img/ecommerce-images/product-page-01-related-product-01.jpg" alt="Services" class="w-full h-64 object-cover">
                    <div class="absolute bottom-0 left-0 bg-black bg-opacity-50 text-white p-4 w-full">
            ...
            <div class="bg-white">
                <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                    <h2 class="text-2xl font-bold tracking-tight text-gray-900">News</h2>

                    <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                        <div class="group relative">
                            <div
                                class="aspect-h-1 aspect-w-1 w-fit overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-full">
                                <img src="https://tailwindui.com/img/ecommerce-images/product-page-01-related-product-01.jpg"
                                    alt="Front of men&#039;s Basic Tee in black."
                                    class="h-full w-full object-cover object-center lg:h-full lg:w-full">
                            </div>
