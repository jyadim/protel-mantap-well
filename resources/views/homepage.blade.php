...
<body>
    <div class="min-h-full">
        ...
        <main>
            ...
            <section
                class="w-fit mx-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 justify-items-center gap-y-10 gap-x-10 mt-10">
                    ...
                    <div
                        ...
                        <a href="/product/{{ $prod->slug }}">
                            ...
                            <div class="px-4 py-3 w-72">
                                ...
                                <p class="text-lg font-bold text-black truncate block capitalize">{{ $prod->name }}
                                </p>
                                        ...
                                        @foreach ($news as $yt)
                                            <article
                                                ...
                                                <div
                                                    ...
                                                    <time datetime="{{ $yt->formattedDate }} "
                                                        class="mr-8">{{ $yt->formattedDate }}</time>
                                                ...
                                                <h3 class="mt-3 text-lg font-semibold leading-6 text-white">
                                                    <a href="{{ $yt->link }}"><span
                                                            class="absolute inset-0"></span>{{ $yt->title }}</a>
                                                </h3>
                                            </article>
                                        @endforeach
                                    </div>
